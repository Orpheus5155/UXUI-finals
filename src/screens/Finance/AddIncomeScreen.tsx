...
const AddIncomeScreen = () => {
  ...
  const handleAddIncome = () => {
    ...
    Alert.alert('Success', 'Income has been added successfully!', [
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <FinanceHeader title="Add Income" showBack={true} />
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.inputContainer}>
            <TextInput style={styles.input} placeholder="Side Business" placeholderTextColor="#1F2937" />
          </View>
          ...
          <View style={styles.categoryContainer}>
            ...
            <TouchableOpacity style={[styles.categoryButton, styles.activeCategory]}>
              <Text style={[styles.categoryText, styles.activeCategoryText]}>Rewards</Text>
            </TouchableOpacity>
          </View>
        </View>
